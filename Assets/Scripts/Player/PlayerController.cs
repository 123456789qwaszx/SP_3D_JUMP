...
public class PlayerController : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        if (!p_IsGrounded)
            _animator.SetFloat(p_HashAirborneVerticalSpeed, _verticalSpeed * 0.08f);
    }
    ...
    public void Jump()
    {
        ...
        else
        {
            ...
            _controller.Move(_verticalSpeed * Vector3.up * Time.deltaTime);
        }
